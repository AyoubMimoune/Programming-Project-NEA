...
Public Class Form1
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox5.Text = "" Then 'Check if the textboxes are empty 
            MsgBox("Please enter the correct information")'Notifies  user that they haven't entere information 
        ...
        Else
            ...
            Try
                ...
                conn.Open()
                'Executing query of insering user data into database
                cmd.ExecuteNonQuery()
                'Notifies user that registration successfully completed
                MsgBox("Registration successfully completed")
                'If there is an excpetion i.e. there is an error then the user will be notified that something went wrong
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Else
            uname = TextBox4.Text
            pword = TextBox3.Text
            Dim querry As String = "Select password From Table1 where name= '" & uname & "'" 'Selecting the users password from the DB
            Dim dbsource As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\A\Documents\Database1.accdb"
        ...
        If (pword = pass) Then
            ...
            If System.IO.File.Exists("C:\Users\A\Desktop\" + TextBox4.Text + ".png") Then
                Dim result = MsgBox("Yes to create new timetable  " + vbCrLf + "No to view current timetable.", vbYesNo)
                If result = MsgBoxResult.Yes Then
                    Form2.Show()
                    Me.Hide()
                ElseIf result = MsgBoxResult.No Then
                    Process.Start("C:\Users\A\Desktop\" + TextBox4.Text + ".png")
                    Me.Close()
                End If
            End If
            If (pword = pass) Then
